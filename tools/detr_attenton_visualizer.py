...
def visualize_self_attention(image,image_tensor, bbox_scaled_c, bbox_c, attention):
    ...
    if args.backbone_name == 'base':
        plt.savefig('results/YOLOS_base/MOT15_val_attention_visualize/'+save_image_path, bbox_inches='tight', pad_inches=0, dpi=300)
    elif args.backbone_name == 'tiny':
        plt.savefig('results/YOLOS_tiny/MOT15_val_attention_visualize/'+save_image_path, bbox_inches='tight', pad_inches=0, dpi=300)
    else:
