...
def build(image_set, args):
    ...
    assert root.exists(), f'provided PANDAS path {root} does not exist'
    mode = 'pandas_instances'
    PATHS = {
        "train": (root / "trains", root / "annotations" / f'{mode}_train.json'),
        "val": (root / "vals", root / "annotations" / f'{mode}_val.json'),
    }
