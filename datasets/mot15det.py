...
def build(image_set, args):
    ...
    assert root.exists(), f'provided MOT15Det path {root} does not exist'
    mode = 'MOT15_instances'
    PATHS = {
        "train": (root / "train", root / "annotations" / f'{mode}_trains.json'),
        "val": (root / "val", root / "annotations" / f'{mode}_vals.json'),
    }
